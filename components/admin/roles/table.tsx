...
const EnhancedTable = (props:any)=>{
  const {handleRemoveItem} = props;
    ...
    const rows = useSelector((state:any) => state.categoryReducer.categories.map((item:any,index:number)=>createData(item.id,index+1,item.title,item.label,item.description,"")));
                    ...
                    return (
                      ...
                      >
                       ...
                       align="center">
                        ...
                        <TableCell align="center"><span>{row.label}</span></TableCell>
                        
                        <TableCell align="center" >
                          <div style={{display:"flex",justifyContent:"center"}} >
                          
                            <Link href={`/hamyar-web/admin/roles/edit/${row.id}`}>
                                <LinkEl  href={`/hamyar-web/admin/roles/edit/${row.id}`} >
                                <MdEditEl />
                                </LinkEl>
                            </Link>
