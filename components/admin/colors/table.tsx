...
const EnhancedTable = (props:any)=>{
  const {handleRemoveItem} = props;
    ...
    const rows = useSelector((state:any) => state.colorReducer.colors.map((item:any,index:number)=>createData(item.id,index+1,item.title,item.value,"")));
                       ...
                       align="center">
                        ...
                        <TableCell align="center" >
                          <div style={{display:"flex",justifyContent:"center"}} >
                            ...
                            <Link href={`/hamyar-web/admin/colors/edit/${row.id}`}>
                                <LinkEl  href={`/hamyar-web/admin/colors/edit/${row.id}`} >
                                <MdEditEl />
                                </LinkEl>
                            </Link>
