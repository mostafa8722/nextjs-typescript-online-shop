                    ...
                    return (
                      ...
                      >
                       ...
                       align="center">
                        ...
                        <TableCell align="center"><span>{row.body}</span></TableCell>
                        <TableCell align="center">{row.image}</TableCell>
                        <TableCell align="center">{row.parent}</TableCell>
                        <TableCell align="center" >
                          <div style={{display:"flex",justifyContent:"center"}} >
                          
                            <Link href={`/hamyar-web/admin/categories/edit/${row.id}`}>
                                <LinkEl  href={`/hamyar-web/admin/categories/edit/${row.id}`} >
                                <MdEditEl />
                                </LinkEl>
                            </Link>
