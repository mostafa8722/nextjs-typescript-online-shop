...
import { validationsize } from "../../../logic/validations/adminValidations";
import { adminSizes,addSize,updateSize,adminSizeRequest } from "../../../api/admin/size";
...
const SizePage = ()=>{
  ...
  const  size= useSelector((state:any) => state.sizeReducer.size);
  ...
  const path_type = useRouter().pathname=="/hamyar-web/admin/sizes/add"?"add":"edit";
  ...
  useEffect(()=>{
   ...
   dispatch(loadingPage(false))
    if(router.query.id)
    adminSizeRequest(dispatch,router.query.id)
  ...
  const formik:any = useFormik({
    ...
    validationSchema: validationsize,
              ...
              <SideBar />
               {
                ...
                <ButtomDivEl>
                  <ButtonEl  >
                   ...
                   <>
                      {
                    path_type=="add"?"افزودن سایز":"ویرایش سایز"
                  }
                   </>
                   }
...
export default connect()(SizePage);