...
const EnhancedTable = (props:any)=>{
  const {handleRemoveItem} = props;
    ...
    const rows = useSelector((state:any) => state.brandReducer.brands.map((item:any,index:number)=>createData(item.id,index+1,item.title,"")));
                       ...
                       align="center">
                        ...
                        <TableCell align="center" >
                          <div style={{display:"flex",justifyContent:"center"}} >
                            ...
                            <Link href={`/hamyar-web/admin/brands/edit/${row.id}`}>
                                <LinkEl  href={`/hamyar-web/admin/brands/edit/${row.id}`} >
                                <MdEditEl />
                                </LinkEl>
                            </Link>
