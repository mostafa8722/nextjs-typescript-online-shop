...
import { adminAddBanner,bannerRequest,adminUpdateBanner } from "../../../api/admin/banner";
...
const CatPage = ()=>{
  ...
  const path_type = useRouter().pathname=="/hamyar-web/admin/banners/add"?"add":"edit";
  ...
  useEffect(()=>{
    ...
    if(router.query.id)
    bannerRequest(dispatch,router.query.id)
