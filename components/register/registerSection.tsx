...
const customInputStyle= (width:number)=>{
  return {  width: width,
   ...
   return (
    <LoginEl>
          <TitleEl>ثبت نام همیارشاپ</TitleEl>
         <LabelEl>ورود</LabelEl>
        <CustomInput
        name="mobile"
        ...
        <ButtonEl >ورود</ButtonEl>
           ...
           <RegisterEl>
             <TextEl>
               با ثبت نام در همیارشاپ کلیه 
             </TextEl>
           <Link href="/register">   
            <LinkEl href="/register"> قوانین و مقررات  </LinkEl>
            </Link>
            <TextEl>
               استفاده از سایت را مطالعه کرده و پذیرفته ام
             </TextEl>
           </RegisterEl>
    </LoginEl>
   );
