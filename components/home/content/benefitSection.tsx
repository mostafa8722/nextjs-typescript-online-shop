...
const BenefitEl = styled("div")<{count:number}>(({count})=>`
display:grid;
...
const BenefitSection = ()=>{
    ...
    const items = [
        ...
        {id:3,title:"7 روز هفته ،24 ساعته",Icon:FaAngleDown,link:"/page/3"},
        {id:4,title:"هفت روز ضمانت بازگشت",Icon:FaAngleDown,link:"/page/4"},
