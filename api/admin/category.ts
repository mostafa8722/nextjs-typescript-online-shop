...
import {add,loadCategory,loadData, loadData2, loadData3,} from "../../store/actions/category"
...
export const categoryRequest:any = (dispatch:any,id:number)=>{
...
export const adminUpdateCategory:any = (dispatch:any,data:any)=>{
  dispatch(isDataSuccess(false));
  dispatch(loading(true))
...
export const adminDeleteCategory:any = (dispatch:any,id:number)=>{
  dispatch(isDataSuccess(false));
  dispatch(loading(true))
